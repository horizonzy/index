...
public class DbBatchInsert {
    ...
    static String s[]={"北京","河北","河南","湖南","湖北","山西","山东","海南","海口",
            "深圳","广州","广西","东莞","成都","德阳","重庆","绵阳","承德","哈尔滨"};//地方
    static String s1[]={"京东","耐克","阿达","腾讯 ","统一","百度","360"
            ,"阿里巴巴","钢铁","小米","锤子","苹果","辅龙","亚马逊"};//公司
    ...
    public static void main(String[] args) throws SQLException {
        ...
        dataSource.setUrl("jdbc:mysql://localhost:3306/index");
        ...
        for(int i=0;i<100000;i++) {
            ...
            statement.executeUpdate("insert INTO  zy_index(company_name) VALUES ('" + s[random] + s1[random2] + s2[random3] +"')", Statement.RETURN_GENERATED_KEYS);
        }
